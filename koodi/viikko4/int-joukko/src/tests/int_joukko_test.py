...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertEqual(joukko.palauta_alkioiden_maara(), 14)
        self.assertTrue(joukko.kuuluu(11))
        joukko.poista(11)
        self.assertFalse(joukko.kuuluu(11))
        self.assertEqual(joukko.palauta_alkioiden_maara(), 13)

    def test_lukuja_lisatty_maara(self):
        self.joukko.lisaa(4)
        self.assertEqual(self.joukko.palauta_alkioiden_maara(), 3)

    def test_sama_luku_menee_joukkoon_vaan_kerran(self):
        self.joukko.lisaa(10)
        self.joukko.lisaa(3)
        self.assertEqual(self.joukko.palauta_alkioiden_maara(), 2)
    ...
    def test_poistettu_ei_ole_enaa_joukossa(self):
        ...
        self.assertEqual(self.joukko.palauta_alkioiden_maara(), 1)
